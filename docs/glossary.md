...
### README.md
Top-level overview of the project and instructions for using the helper scripts.

### CONTRIBUTING.md
Guidelines detailing the contribution workflow and coding style.

### LICENSE
Creative Commons Attribution 4.0 text governing use of this repository.

### fixes-1.md
Issue log summarising known problems and proposed fixes.

### mkdocs.yml
Configuration for building the documentation site with MkDocs Material.

### .pre-commit-config.yaml
Defines the linting and validation hooks that run before each commit.

### extraction_log.json
Log file generated by `extract_urls.py` summarising processed links.

### pdfs/README.md
Explains how cached PDFs are stored using hashed filenames.
