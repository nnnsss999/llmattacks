...
- [Ctta: a novel chain-of-thought transfer adversarial attacks framework for large language models](https://doi.org/10.1186/s42400-024-00338-1)
- [How private are your chat adapters? Evaluating the privacy of LoRA fine-tuned large language models with membership inference attacks](https://doi.org/10.1117/12.3053265)
- [Distributed Denial of Service Attack with Large Language Model](https://doi.org/10.54097/586gg060)
- [Towards Effective Identification of Attack Techniques in Cyber Threat Intelligence Reports using Large Language Models](https://doi.org/10.1145/3701716.3715469)
