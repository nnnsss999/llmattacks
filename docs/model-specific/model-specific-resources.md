...
- [Jailbreaker in Jail: Moving Target Defense for Large Language Models](https://dl.acm.org/doi/10.1145/3605760.3623764)
...
- [Time Will Tell: Timing Side Channels via Output Token Count](https://arxiv.org/html/2412.15431v1)
- [InputSnatch: Novel Side-Channel Attack Stealing LLM Inputs](https://cybersecuritynews.com/inputsnatch-novel-side-channel-attack/)
- [NLSR: Neuron-Level Safety Realignment of Large Language Models Against Harmful Fine-Tuning](https://ojs.aaai.org/index.php/AAAI/article/view/34762)
- [NAT: Learning to Attack Neurons for Enhanced Adversarial Transferability](https://openaccess.thecvf.com/content/WACV2025/papers/Nakka_NAT_Learning_to_Attack_Neurons_for_Enhanced_Adversarial_Transferability_WACV_2025_paper.pdf)
- [Order vs. Chaos: A Language Model Approach for Side-channel Attacks](https://eprint.iacr.org/2023/1615)
