...
- `visual-jailbreaking-resources-2033.md` — references on vision-based attacks from later research
- `visual-jailbreaking-resources-2034.md` — latest papers on multimodal jailbreaking
