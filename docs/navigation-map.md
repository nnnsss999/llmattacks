...
- `visual-jailbreaking-resources-2033.md` — supplemental references on post-2032 visual jailbreak research
- `visual-jailbreaking-resources-2034.md` — expanded list of multimodal jailbreak papers
- `visual-jailbreaking-resources-2035.md` — latest papers on image-based jailbreaks
